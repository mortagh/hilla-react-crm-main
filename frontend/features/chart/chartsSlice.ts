...
export const chartsSlice = createSlice({
	...
	reducers: {
		...
		selectChartForCurveEdit: (state, action: PayloadAction<Chart | null>) => {
			state.chartForCurveEdit = action.payload;
		}
	},
...
export const { updateFilter, selectChart, selectChartForCurveEdit } = chartsSlice.actions
